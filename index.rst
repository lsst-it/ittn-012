...
.. table:: CLS Dashboard.
    ...
    +========+===========================================+================================================================================================================================================================================+==================================+========================+
    |   1    |  Top Access to Servers                    | collector:servers AND message:"sudo" AND NOT sudo_user:"pam_unix(sudo" AND NOT sudo_user:"pam_unix(sudo-i" AND NOT sudo_user:"pam_sss(sudo" AND NOT sudo_user:"pam_sss(sudo-i" | Quick Value with Pie Chart&Table | source/sudo_user       |
    +--------+-------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------+------------------------+
